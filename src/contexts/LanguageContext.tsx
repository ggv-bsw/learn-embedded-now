...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'docs.hero.description': 'Comprehensive guides, tutorials, and technical documentation to help you master embedded systems development.',
    ...
    'docs.section.gettingStarted.desc': 'Learn how to begin your journey with our platform and courses',
    ...
    'docs.section.courseGuides.desc': 'Detailed guides for each course including setup and requirements',
    ...
    'docs.section.technicalRef.desc': 'In-depth technical references and API documentation',
    ...
    'docs.section.toolsSetup.desc': 'Setup guides for development environments and tools',
    ...
    'docs.section.faqs.desc': 'Common questions and answers about our courses and platform',
    ...
    'docs.cta.description': 'Our support team is here to help. Get in touch and we\'ll respond as quickly as possible.',
    ...
    'blog.hero.subtitle': 'Join the Rebellion against complex code. Learn the ways of the Force in embedded systems, Arduino mastery, and IoT wisdom from Jedi Masters across the galaxy.',
    ...
    'hardware.hero.description': 'Professional-grade development boards and microcontrollers for your embedded projects.',
    ...
    'hardware.featured.description': 'Hand-picked selection of the best microcontrollers and development platforms',
    ...
    'hardware.features.description': 'Professional service and support for all your embedded development needs',
    'hardware.feature.quality.title': 'Quality Guaranteed',
    'hardware.feature.quality.description': 'All boards tested and verified before shipping',
    'hardware.feature.shipping.title': 'Fast Shipping',
    'hardware.feature.shipping.description': 'Same-day processing with 2-3 day delivery',
    'hardware.feature.support.title': 'Technical Support',
    'hardware.feature.support.description': 'Expert help with setup and troubleshooting',
    
    // Contact Page
    'contact.hero.badge': 'Get In Touch',
    'contact.hero.title': 'We\'re Here to',
    'contact.hero.titleHighlight': 'Help You Succeed',
    'contact.hero.description': 'Have questions about our courses? Need guidance on your embedded systems journey? Our team of experts is ready to assist you every step of the way.',
    ...
    'contact.faq.description': 'Quick answers to common questions about our courses and services',
    'contact.faq.q1': 'Do you offer courses in Romanian and Russian?',
    'contact.faq.a1': 'Yes! All our courses are available in Romanian, Russian, and English. You can switch between languages anytime in your student dashboard.',
    'contact.faq.q2': 'What equipment do I need for the embedded systems courses?',
    'contact.faq.a2': 'We provide starter kits for most courses, including Arduino boards, sensors, and components. For advanced courses, we\'ll provide a detailed equipment list.',
    'contact.faq.q3': 'Are there any prerequisites for your courses?',
    'contact.faq.a3': 'Basic programming knowledge is helpful but not required for beginner courses. Each course page lists specific prerequisites if any.',
    'contact.faq.q4': 'Do you offer certificates upon completion?',
    'contact.faq.a4': 'Yes, all students receive industry-recognized certificates upon successful course completion. These are valued by employers across Moldova and Romania.',
    'contact.faq.q5': 'Can I get help if I\'m stuck during a course?',
    'contact.faq.a5': 'Absolutely! We offer 24/7 community support, weekly live Q&A sessions, and one-on-one mentoring for premium students.',
    ...
    'contact.cta.description': 'Join thousands of students mastering embedded systems. Get started today with our beginner-friendly courses.',
  ...
  ro: {
    ...
    'docs.hero.description': 'Ghiduri complete, tutoriale și documentație tehnică pentru a-ți stăpâni dezvoltarea sistemelor embedded.',
    ...
    'docs.section.gettingStarted.desc': 'Învață cum să începi călătoria cu platforma și cursurile noastre',
    ...
    'docs.section.courseGuides.desc': 'Ghiduri detaliate pentru fiecare curs incluzând configurare și cerințe',
    ...
    'docs.section.technicalRef.desc': 'Referințe tehnice aprofundate și documentație API',
    ...
    'docs.section.toolsSetup.desc': 'Ghiduri de configurare pentru medii de dezvoltare și instrumente',
    'docs.section.toolsSetup.vscode': 'Configurare VS Code pentru Dezvoltare Embedded',
    ...
    'docs.section.faqs.desc': 'Întrebări și răspunsuri comune despre cursurile și platforma noastră',
    ...
    'docs.cta.description': 'Echipa noastră de suport este aici să te ajute. Contactează-ne și vom răspunde cât mai rapid posibil.',
    ...
    'blog.hero.subtitle': 'Alătură-te Rebeliunii împotriva codului complex. Învață căile Forței în sisteme embedded, măiestria Arduino și înțelepciunea IoT de la Maeștrii Jedi din întreaga galaxie.',
    ...
    'hardware.hero.description': 'Plăci de dezvoltare și microcontrolere profesionale pentru proiectele tale embedded.',
    ...
    'hardware.featured.description': 'Selecție manuală a celor mai bune microcontrolere și platforme de dezvoltare',
    ...
    'hardware.features.description': 'Servicii și asistență profesională pentru toate nevoile tale de dezvoltare embedded',
    'hardware.feature.quality.title': 'Calitate Garantată',
    'hardware.feature.quality.description': 'Toate plăcile sunt testate și verificate înainte de expediție',
    'hardware.feature.shipping.title': 'Livrare Rapidă',
    'hardware.feature.shipping.description': 'Procesare în aceeași zi cu livrare în 2-3 zile',
    'hardware.feature.support.title': 'Suport Tehnic',
    'hardware.feature.support.description': 'Ajutor expert cu instalarea și depanarea',
    ...
    'contact.hero.description': 'Ai întrebări despre cursurile noastre? Ai nevoie de ghidare în călătoria ta în sistemele embedded? Echipa noastră de experți este pregătită să te asiste la fiecare pas.',
    ...
    'contact.form.messagePlaceholder': 'Spune-ne mai multe despre întrebarea ta...',
    'contact.form.sending': 'Se trimite...',
    'contact.form.send': 'Trimite Mesajul',
    'contact.form.success': 'Mesaj trimis cu succes! Îți vom răspunde în 24 de ore.',
    'contact.form.error': 'Nu s-a putut trimite mesajul. Te rugăm să încerci din nou.',
    ...
    'contact.faq.description': 'Răspunsuri rapide la întrebări comune despre cursurile și serviciile noastre',
    'contact.faq.q1': 'Oferiți cursuri în română și rusă?',
    'contact.faq.a1': 'Da! Toate cursurile noastre sunt disponibile în română, rusă și engleză. Poți schimba limba oricând în panoul tău de student.',
    'contact.faq.q2': 'Ce echipament am nevoie pentru cursurile de sisteme embedded?',
    'contact.faq.a2': 'Oferim kituri de început pentru majoritatea cursurilor, incluzând plăci Arduino, senzori și componente. Pentru cursurile avansate, vom oferi o listă detaliată de echipamente.',
    'contact.faq.q3': 'Există prerechizite pentru cursurile dvs.?',
    'contact.faq.a3': 'Cunoștințe de bază de programare sunt utile, dar nu sunt necesare pentru cursurile de început. Fiecare pagină de curs listează prerechizitele specifice, dacă există.',
    'contact.faq.q4': 'Oferiți certificate la absolvire?',
    'contact.faq.a4': 'Da, toți studenții primesc certificate recunoscute în industrie la finalizarea cu succes a cursului. Acestea sunt apreciate de angajatori în Moldova și România.',
    'contact.faq.q5': 'Pot primi ajutor dacă rămân blocat în timpul unui curs?',
    'contact.faq.a5': 'Absolut! Oferim suport comunitar 24/7, sesiuni live Q&A săptămânale și mentorat individual pentru studenții premium.',
    ...
    'contact.cta.description': 'Alătură-te miilor de studenți care stăpânesc sistemele embedded. Începe astăzi cu cursurile noastre pentru începători.',
  ...
  ru: {
    ...
    'docs.hero.description': 'Полные руководства, учебные материалы и техническая документация для освоения разработки встраиваемых систем.',
    'docs.search.placeholder': 'Поиск в документации...',
    'docs.quickLinks.community': 'Форум Сообщества',
    'docs.quickLinks.communityDesc': 'Присоединяйтесь к обсуждениям с другими студентами',
    'docs.quickLinks.resources': 'Технические Ресурсы',
    'docs.quickLinks.resourcesDesc': 'Документация по оборудованию и инструментам',
    ...
    'docs.section.gettingStarted.desc': 'Узнайте, как начать свой путь с нашей платформой и курсами',
    ...
    'docs.section.courseGuides.desc': 'Подробные руководства для каждого курса, включая настройку и требования',
    'docs.section.courseGuides.python': 'Предварительные Требования Курса Python',
    ...
    'docs.section.technicalRef.desc': 'Подробные технические справочники и документация API',
    'docs.section.technicalRef.arduino': 'Справочник по Программированию Arduino',
    ...
    'docs.section.toolsSetup.desc': 'Руководства по настройке сред разработки и инструментов',
    'docs.section.toolsSetup.vscode': 'Настройка VS Code для Встраиваемой Разработки',
    ...
    'docs.section.faqs.desc': 'Общие вопросы и ответы о наших курсах и платформе',
    ...
    'docs.noResults.message': 'Попробуйте изменить поисковый запрос или фильтры',
    'docs.noResults.clear': 'Очистить Фильтры',
    'docs.cta.title': 'Остались Вопросы?',
    'docs.cta.description': 'Наша команда поддержки готова помочь. Свяжитесь с нами, и мы ответим как можно быстрее.',
    ...
    'blog.hero.subtitle': 'Присоединяйтесь к Восстанию против сложного кода. Изучайте пути Силы во встраиваемых системах, мастерстве Arduino и мудрости IoT от Мастеров Джедаев со всей галактики.',
    ...
    'hardware.hero.description': 'Профессиональные платы для разработки и микроконтроллеры для ваших встраиваемых проектов.',
    ...
    'hardware.featured.description': 'Тщательно отобранные лучшие микроконтроллеры и платформы для разработки',
    ...
    'hardware.features.description': 'Профессиональное обслуживание и поддержка для всех ваших потребностей во встраиваемой разработке',
    'hardware.feature.quality.title': 'Гарантия Качества',
    'hardware.feature.quality.description': 'Все платы тестируются и проверяются перед отправкой',
    'hardware.feature.shipping.title': 'Быстрая Доставка',
    'hardware.feature.shipping.description': 'Обработка в тот же день с доставкой за 2-3 дня',
    'hardware.feature.support.title': 'Техническая Поддержка',
    'hardware.feature.support.description': 'Экспертная помощь с настройкой и устранением неполадок',
    ...
    'contact.hero.description': 'Есть вопросы о наших курсах? Нужна помощь в вашем путешествии по встраиваемым системам? Наша команда экспертов готова помочь вам на каждом шагу.',
    ...
    'contact.form.messagePlaceholder': 'Расскажите нам больше о вашем запросе...',
    'contact.form.sending': 'Отправка...',
    'contact.form.send': 'Отправить Сообщение',
    'contact.form.success': 'Сообщение успешно отправлено! Мы свяжемся с вами в течение 24 часов.',
    'contact.form.error': 'Не удалось отправить сообщение. Пожалуйста, попробуйте снова.',
    ...
    'contact.faq.description': 'Быстрые ответы на распространенные вопросы о наших курсах и услугах',
    'contact.faq.q1': 'Предлагаете ли вы курсы на румынском и русском языках?',
    'contact.faq.a1': 'Да! Все наши курсы доступны на румынском, русском и английском языках. Вы можете переключаться между языками в любое время в панели студента.',
    'contact.faq.q2': 'Какое оборудование мне нужно для курсов по встраиваемым системам?',
    'contact.faq.a2': 'Мы предоставляем стартовые комплекты для большинства курсов, включая платы Arduino, датчики и компоненты. Для продвинутых курсов мы предоставим подробный список оборудования.',
    'contact.faq.q3': 'Есть ли какие-либо предварительные требования для ваших курсов?',
    'contact.faq.a3': 'Базовые знания программирования полезны, но не требуются для начальных курсов. Каждая страница курса содержит список конкретных предварительных требований, если они есть.',
    'contact.faq.q4': 'Выдаете ли вы сертификаты по окончании?',
    'contact.faq.a4': 'Да, все студенты получают признанные в отрасли сертификаты после успешного завершения курса. Они ценятся работодателями в Молдове и Румынии.',
    'contact.faq.q5': 'Могу ли я получить помощь, если застрял во время курса?',
    'contact.faq.a5': 'Абсолютно! Мы предлагаем круглосуточную поддержку сообщества, еженедельные сессии вопросов и ответов и индивидуальное наставничество для премиум-студентов.',
    ...
    'contact.cta.description': 'Присоединяйтесь к тысячам студентов, осваивающих встраиваемые системы. Начните сегодня с наших курсов для начинающих.',
