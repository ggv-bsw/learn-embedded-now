...
import { Star, MapPin, Clock, Users, Award, Code, Database, Cpu, CheckCircle, Trophy } from "lucide-react";
              ...
              <ScrollReveal key={trainer.id} delay={index * 100}>
                <Card className="group hover:shadow-2xl transition-all duration-300 bg-slate-800/50 border-slate-700 backdrop-blur-sm hover:bg-slate-800/70 hover:scale-105">
                  <CardHeader className="pb-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <CardTitle className="text-xl font-bold mb-1 text-white group-hover:text-blue-400 transition-colors">{trainer.name}</CardTitle>
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500 mb-3">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-white">{trainer.students}</span> students
                          </div>
                          <div className="flex items-center gap-1">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold mb-2 text-sm text-white">Expertise</h4>
                    ...
                    <div>
                      <h4 className="font-semibold mb-2 text-sm text-white">Specialties</h4>
                      <div className="flex flex-wrap gap-2">
                        {trainer.specialties.map((specialty) => (
                          <Badge key={specialty} variant="outline" className="text-xs border-slate-600 text-gray-300 hover:bg-slate-800 hover:border-slate-500">
                            {specialty}
                          </Badge>
                        ))}
                      </div>
                    ...
                    <div className="flex gap-2 pt-2">
                      ...
                      <Button size="sm" variant="outline" className="flex-1 border-slate-600 text-gray-300 hover:bg-slate-800 hover:border-slate-500">
                        Message
                      </Button>
                    </div>
                  </CardContent>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <ScrollReveal>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div className="space-y-2">
                <div className="text-3xl md:text-4xl font-bold text-blue-400">4.9</div>
                <div className="text-sm text-gray-400">Average Rating</div>
              </div>
              <div className="space-y-2">
                <div className="text-3xl md:text-4xl font-bold text-blue-400">4.5K+</div>
